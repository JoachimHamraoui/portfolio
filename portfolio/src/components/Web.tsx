        ...
        <div className="sm:w-10/12 xl:w-9/12 h-full flex flex-row">
          <div className="web mt-14">
            <div className="w-full py-4 mt-5">
              <Reveal><h2 className="text-4xl text-green font-display pb-2 font-bold">Web Development</h2></Reveal>
              <div className="w-full flex flex-row">
                <div className="w-full flex flex-row mt-10 flex-wrap">

                  {WebJson.map((item, index) => (
                    <Link to={`/web/project/${item.id}`}>
                      <div key={index} className="w-full flex sm:flex-col xl:flex-row xl:pr-4 mb-10 tr transition-hover duration-300 hover:p-0.5">
